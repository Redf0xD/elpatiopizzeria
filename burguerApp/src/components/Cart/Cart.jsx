...
export const Cart = () => {
  ...
  return (
    <div>
      <button onClick={() => setShowCart(prev => !prev)}>{!showCart ? "Mostrar" : "Ocultar"}</button>
      {
        showCart 
        ?

      <form className={`${styles.cartDetail} ${styles.active}`}onSubmit={handleSubmit}>
